...
class AudioMotionAnalyzer {
  ...
  _calcBars() {
    ...
    if (this._isOctaveBands) {
      ...
      const steps = [0, 1, 2, 3, 4, 6, 7, 12, 24][this._mode]; // number of notes grouped per band for each mode
      // matrix visualizer edit:made 6th mode have 7 steps instead of 8 (= 34 values)
...
module.exports = AudioMotionAnalyzer;
